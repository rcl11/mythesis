...
This chapter outlines the \ac{SM} $\HToTauTau$ results from Run 1 of the LHC, using the
...
direction, $d_{z}$, must be smaller than $0.2\,\cm$. %note: find out why no d_xy cut
...
is selected. The $\pt$ and $\eta$ distributions of the selected particles in the
...
\subsection{Candidate events in the $\mutau$ channel}
...
is selected. The $\pt$ and $\eta$ distributions of the candidate particles in the
...
\subsection{Extra lepton vetoes}
...
The categorisation separates events which have zero, one or $\geq$ two jets with
$\pt > 30\,\GeV$
...
The $\PZ\to\ell\ell$ ($\ell=\Pe,\Pmu$) background results when one lepton provides the electron or
...
The same sign data is used in this way for extracting the normalisation in all of the
0--jet and 1--jet
...
$\Pgth$ is also loosened to obtain a sufficiently smooth shape. 

\begin{figure}[htb]
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/m_sv_1jet_medium_mt_2012.pdf}}
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/m_sv_vbf_loose_mt_2012.pdf}}
...
derive a scale factor on the \ac{MC} normalisation. This control region will be
discussed further in chapter \ref{chap:Hhh} in the context of an analysis which
has much larger contributions from $\ttbar$ background. In this analysis the
...
Several other data to \ac{MC} corrections are applied in this analysis. 
...
$\epsilon_{MC}$ is the tagging efficiency in \ac{MC}. This is performed
separately for light jets and b-jets, with an explicit check for flavour.
...
The contribution of $\PZ \to \Pe\Pe$ background to the $\etau$ channel
...
uncertainty on the opposite sign - same sign factor of 1.06, which is found to be
...
\subfloat[]{
    \includegraphics[width=0.5\textwidth]
      {plots/htt-sm/ggH125_taues_1jet_high_lowhiggs_mt.pdf}}
\subfloat[]{
    \includegraphics[width=0.5\textwidth]
      {plots/htt-sm/ZTT_taues_1jet_high_lowhiggs_mt.pdf}}
...
$2\%$ shift up and down is included to cover this effect. %maybe add a reference
...
The functional form of the $\mathrm{Constraint}(\theta_{j}, \tilde{\theta}_{j})$ 
...
depends by $\pm 1$ standard deviation. A nuisance parameter $\lambda$
...
From this, the p-value to observe an excess as large or larger than the observed
...
\begin{figure}[tbh]
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/muTau_0jet_medium_postfit_8TeV_LIN.pdf}}
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/muTau_0jet_high_postfit_8TeV_LIN.pdf}}

\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/muTau_1jet_medium_postfit_8TeV_LIN.pdf}}
...
\begin{figure}[tbh]
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/muTau_1jet_high_lowhiggs_postfit_8TeV_LIN.pdf}}
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/muTau_1jet_high_mediumhiggs_postfit_8TeV_LIN.pdf}}

\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/muTau_vbf_loose_postfit_8TeV_LIN.pdf}}
\subfloat[]{
...
\begin{figure}[tbh]
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/eleTau_0jet_medium_postfit_8TeV_LIN.pdf}}
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/eleTau_0jet_high_postfit_8TeV_LIN.pdf}}

\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/eleTau_1jet_medium_postfit_8TeV_LIN.pdf}}
...
\begin{figure}[tbh]
%\subfloat[]{
%\includegraphics[width=0.5\textwidth]{plots/htt-sm/eleTau_1jet_high_lowhiggs_postfit_8TeV_LIN.pdf}}
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/eleTau_1jet_high_mediumhiggs_postfit_8TeV_LIN.pdf}}

\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/eleTau_vbf_loose_postfit_8TeV_LIN.pdf}}
\subfloat[]{
...
From the individual $m_{\Pgt\Pgt}$ distributions it is difficult to assess the
...
\begin{figure}[h!]
\subfloat[]{
\includegraphics[width=0.5\textwidth]{plots/htt-sm/Plot_All_SM.pdf}}
...
$\HToTauTau$. This result, along with the corresponding result from the ATLAS
experiment, provides the first evidence of the $125\,\GeV$ Higgs boson decaying into
fermions, and marks an extremely important milestone in Higgs boson physics at
the LHC.

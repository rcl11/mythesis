...
At large $\tan\beta$ and for $m_{\PA} \gg m_{\Ph}^{\text{max}}$, $m_{\PA}
...
close to those in the \ac{SM}. In the limit where $m_{\PA} \gg m_{\PZ}$, 
...
braching ratios of the $\PA$, shown in figure \ref{fig:mhmaxBRs} for $\tan\beta$
...
motivates searches for the \ac{MSSM} Higgs bosons in final states of $\Pgt\Pgt$
or $\Pqb\Pqb$. Chapter \ref{chap:htt-mssm} discusses the most recent results 
...
bosons, $\Pphi=\PH,\PA,\Ph$. As in the \ac{SM} case the gluon fusion procees
...
final state of $\Pgt\Pgt\Pqb\Pqb$.

...
$\tilde{\theta}_{j}$. The choice of $\tilde{\theta}_{j}$ is usually determined
by external measurements.

The functional form of the $Constraint$ term depends on the type of systematic
uncertainty that it represents.

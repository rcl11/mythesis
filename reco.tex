...
hadronic taus. The \ac{HPS} makes us of \ac{PF} candidates to reconstruct the
...
The algorithm is seeded by a PF jet which is reconstructed as described in
section \ref{sec:jetID}.   
...
\end{center}
\caption{Plots illustrating the tau decay modes.
}

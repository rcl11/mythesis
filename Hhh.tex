...
Therefore, a large amount of the methods discussed in chapters 
\ref{chap:htt-sm} and \ref{chap:htt-mssm} can be applied to this analysis.
...
$\PH\to\Ph\Ph$ signal. Distribution shown for events in the $\mutau$ (left) and $\etau$
(right) channels. }
\label{fig:Hhhnjets}
\end{figure} 

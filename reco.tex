...
%In the $\PH\to\Pgt\Pgt$ analysis the electrons and
...
\end{center}
\caption[Relative jet energy response as a function of jet $\eta$ measured in dijet
events.]{
...
%The $\PH\to\Pgt\Pgt$ analysis makes 
%use of this discriminator in the tight working point, which reduces the rate of misidentified electrons to around
%$3\%$. 

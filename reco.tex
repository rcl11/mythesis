...
In order to further reduce background contributions from mis-identified QCD jets,
...
interact with the CMS detector. We infer their production from the resulting
...
MC, and a correction is derived from an independent $\PZ\to\Pmu\Pmu$ sample which
...
typical jet. This allows us differentiation between hadronic taus and

...
and all three neutral Higgs bosons. No significant excess of events in data is seen compared 
...
$m_{h}^{\text{max}}$ scenario.]{Expected and observed limit in the $m_{\PA}-\tan\beta$ plane of the
$m_{h}^{\text{max}}$ scenario. In the left hand plot, the \ac{MSSM} signal is
...
\caption[Expected and observed limit in the $m_{\PA}-\tan\beta$ plane of the
$m_{h}^{\text{mod+}}$ scenario (a) and $m_{h}^{\text{mod-}}$ scenario (b).]
{Expected and observed limit in the $m_{\PA}-\tan\beta$ plane of the
$m_{h}^{\text{mod+}}$ scenario (a) and $m_{h}^{\text{mod-}}$ scenario (b). Hypothesis

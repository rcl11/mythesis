...
The categorisation separates events which have zero, one or $\geq$ two jets with $\pt > 30~\GeV$
...
$m_{\Pgt\Pgt}$ distributions obtained as a result of this fit 
figures~\ref{fig:postfit0jet1jetmutau} to~\ref{fig:postfit1jetvbfetau} 
for the $\mutau$ and $\etau$ channels. The signal

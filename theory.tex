...
$m_{\PH}=\sqrt{2}\mu_{SM}$, is not directly predicted by the \ac{SM}. The value
can however be constrained by radiative corrections to the $\PW$ and the top
quark \cite{}.
...
low-$\tan\beta$-high scenario~\cite{}. Such a scenario depends on radiative
...
Figure~\ref{fig:lowtanbhighBRs} shows the branching ratio for the $\Hhh$
...
significantly enhanced, illustrating how analyses targeting the $\Hhh$ process will be
sensitive in such regions.

\begin{figure}[htbp]
   \includegraphics[width=0.5\textwidth]{plots/theory/low-tanb-high-BR.pdf}
\caption[Branching ratios for the $\Hhh$ process in the low-$\tan\beta$-high
scenario for different values of $m_{\PA}$ and $\tan\beta$.]{
Branching ratios for the $\Hhh$ process in the low-$\tan\beta$-high
scenario for different values of $m_{\PA}$ and $\tan\beta$. The branching ratio
can be significantly enhanced in these regions~\cite{}.}
...
method can be found in~\cite{}.Both methods are currently being studied by the 
